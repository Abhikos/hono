...
/**
 * A filter for verifying the format of <em>Alarm</em> messages.
 */
public final class EventMessageFilter extends BaseMessageFilter {
     ...
     * @return {@code true} if the given message complies with the <em>Alarm</em> API specification, {@code false}
     *         otherwise.
     */
